...
template.innerHTML = `<vaadin-iconset name="lucid-icons" size="24">
  <svg><defs>
    <g id="a-arrow-down">
      <svg
    ...
    <g id="align-horizontal-distribute-center">
      <svg
    ...
    <g id="align-horizontal-distribute-end">
      <svg
    ...
    <g id="align-horizontal-distribute-start">
      <svg
    ...
    <g id="align-horizontal-justify-center">
      <svg
    ...
    <g id="align-horizontal-justify-end">
      <svg
    ...
    <g id="align-horizontal-justify-start">
      <svg
    ...
    <g id="align-horizontal-space-around">
      <svg
    ...
    <g id="align-horizontal-space-between">
      <svg
    ...
    <g id="align-vertical-distribute-center">
      <svg
    ...
    <g id="align-vertical-distribute-end">
      <svg
    ...
    <g id="align-vertical-distribute-start">
      <svg
    ...
    <g id="align-vertical-justify-center">
      <svg
    ...
    <g id="align-vertical-justify-end">
      <svg
    ...
    <g id="align-vertical-justify-start">
      <svg
    ...
    <g id="align-vertical-space-around">
      <svg
    ...
    <g id="chart-no-axes-column-decreasing">
      <svg
    ...
    <g id="chart-no-axes-column-increasing">
      <svg
    ...
    <g id="chevrons-left-right-ellipsis">
      <svg
    ...
    <g id="circle-arrow-out-down-left">
      <svg
    ...
    <g id="circle-arrow-out-down-right">
      <svg
    ...
    <g id="circle-arrow-out-up-right">
      <svg
    ...
    <g id="file-chart-column-increasing">
      <svg
    ...
    <g id="git-pull-request-create-arrow">
      <svg
    ...
    <g id="square-arrow-out-down-left">
      <svg
    ...
    <g id="square-arrow-out-down-right">
      <svg
    ...
    <g id="square-bottom-dashed-scissors">
      <svg
    ...
    <g id="square-dashed-bottom-code">
      <svg
